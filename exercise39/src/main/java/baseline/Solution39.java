...
public class Solution39
{
    ...
    {
        HashMap<String, String> firstNames = new HashMap<>();// store first names in strings
    ...
    public HashMap positionMap(String[] lastNames)//store last names in strings
    {
    ...
    public HashMap seperationDateMap(String[] lastNames)// store seperation date in strings
    ...
    private void printTable(ArrayList<HashMap<String, String>> employees, String[] lastNames)// function for printing table
    {
    ...
    public static void main(String[] args)
    {
        ...
        String[] lastNames =  {"Johnson", "Xiongnu", "Michelson", "Jacobson", "Jackson", "Webber"};
